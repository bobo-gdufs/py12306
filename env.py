...
USER_ACCOUNTS = [
    # 目前已支持仅查询，不下单，屏蔽掉下面的账号即可
    {
        ...
        'user_name': '18826102624',
        'password': 'popov4bbqq306_'
    },
    # {
    #     'key': 'wangwu',
...
NOTIFICATION_API_APP_CODE = '7b1f01e5532e46299c516f6f52c49e50'
NOTIFICATION_VOICE_CODE_PHONE = '18520840529'  # 接受通知的手机号
